        ...
        <div class="col-lg-6 col-md-6">
            ...
            <form action="{{ route('tenaga_kesehatan.store') }}" method="post" id="formTenagaKesehatan">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="font-size-h4">Tempat Bekerja - Kota</label>
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="font-size-h4">Tempat Bekerja - Provinsi</label>
                            <input type="text" class="form-control mt-3" name="provinsi" placeholder="Jawaban anda">
                        </div>
                    </div>
                    <!--end::Body-->
                </div>
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="font-size-h4">Tempat Bekerja - Nama Instansi</label>
